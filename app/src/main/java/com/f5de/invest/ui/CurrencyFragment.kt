...
class CurrencyFragment : FragmentEx() {
    ...
    var stocks: ArrayList<Deposit> = ArrayList()
    ...
    override fun update(){
        if (controller != null) {
            stocks = controller?.getData(1)!! as ArrayList<Deposit>
    ...
    fun addCard(userStock: Deposit, index: Int) {
...
//        }
    ...
    fun updateCards(stock: ArrayList<Deposit>?) {
        var i = 0
